...
// 不需要权限过滤的 白名单接口
export const TestWhiteList = ['http://jsonplaceholder.typicode.com/posts/1/comments']
export const WhiteList = ['/v1/user/login', '/v1/user/permission', '/v1/account/info'].concat(
  TestWhiteList,
)

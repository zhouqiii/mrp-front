    ...
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      const PDFViewerApplication = {
        ...
        setInitialView(storedHash, { rotation, sidebarView, scrollMode, spreadMode } = {}) {
          ...
          console.log(this.pdfViewer.currentScale, '3333333333333333333333')
          //获取参数
          if (c_url.indexOf('&') && c_url.indexOf('=')) {
            ...
            // 在/pdfjs-3.5.141-dist/web/viewer.html?file=xxxx后面拼参数 zoom缩放比例 page跳转制定页码 top页面制定位置
            // /pdfjs-3.5.141-dist/web/viewer.html?file=xxxx&zoom=xxx&page=xxx&top=xxxx
            // 默认缩放比例
            if (c_urlArray['zoom']) {
            ...
            if (c_urlArray['top']) {
              document.getElementById('viewerContainer').scrollTop =
                document.getElementById('viewerContainer').scrollTop + c_urlArray['top'] * 1
            }
          }
          // 自定义修改配置结束 zq 0107
        },
